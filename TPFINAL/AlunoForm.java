...
public class AlunoForm extends JFrame implements ActionListener {
    ...
    private void registrarEventos() {
        // Registro de eventos para os botões e janela
        addWindowListener(new SairAction());
        btnSair.addActionListener(new SairAction());

        // Lista de campos de texto para a ação de limpar
    ...
    private void adicionandoCamposPanel() {
        // Configuração dos painéis de campos e botões
        ...
        pnlBotoes.setLayout(new GridLayout(2, 2));
    ...
    // Métodos relacionados às ações dos botões
    @Override
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnApresentarDados)
            apresentarDados();
    ...
    private void apresentarDados() {
        // Obter dados do aluno e converter para JSON
    ...
    public static void main(String[] args) {
        ...
        AlunoForm f = new AlunoForm("TRABALHO FINAL");
        f.setVisible(true);
    }
}
